    ...
    _createClass(select_ticket, [{
        ...
        value: function vue_() {
            this.vue = new VueP({
                ...
                data: {
                    list: [],
                    ticketTitle: [{ text: '', num: 0, list: [], choose: true }]
                },
                methods: {
                    ...
                    init: function init() {
                        ...
                        Util.ajax(dataStr, db.data.api + 'getUserAvailableTicketList.php', function (data) {
                            if (data.e !== 0) {} else {
                                var i = 0;
                    ...
                    ticketChoose: function ticketChoose(tid) {
                        var _this4 = this;

                        var dataStr = '{\n                            "oid":' + db.data.jsapi_order_id + ',\n                            "tid":' + tid + '\n                        }';
                        Util.ajax(dataStr, db.data.api + 'setOrderTicket.php', function (data) {
                            // alert(JSON.stringify(data));
                            if (data.e !== 0) {
                                MessageBarber.alert("使用失败!请联系管理员!");
                            } else {
                                Message.toast("选择成功!", 3);
                                _this4.jump('jsapi');
                            }
                        });
                    }
