    ...
    _createClass(index, [{
        ...
        value: function vue_() {
            this.vue = new VueP({
                ...
                data: {
                    nowBottomIndex: 0,
                    bottomNav: [{ choose: true, text: '排队', right_text: '', right_img: 'work_table.png', imgUnClick: 'line_up.png', imgClick: 'line_up_click.png' }, { choose: false, text: '业绩', right_text: '', right_img: '', imgUnClick: 'analysis.png', imgClick: 'analysis_click.png', func: function func() {
                            window.index.vue.getStatistics();
                        } }, { choose: false, text: '评价', right_text: '', right_img: '', imgUnClick: 'share.png', imgClick: 'share_click.png', func: function func() {
                            window.index.vue.getEveluate();
                        } }, { choose: false, text: '客流', right_text: '', right_img: '', imgUnClick: 'message.png', imgClick: 'message_click.png', func: function func() {
                    ...
                    message_view: [{ title: '支付消息', text: '暂无消息', img: 'money.png', isEnd: false }, { title: '顾客评价', text: '暂无消息', img: 'evaluate.png', isEnd: false }, { title: '店务通知', text: '暂无消息', img: 'stoe.png', isEnd: false }, { title: '系统通知', text: '暂无消息', img: 'sys.png', isEnd: false }, { title: '查验证码', text: '点击查询', img: 'consultation.png', isEnd: true, hash: "query_bind_code" }],
                    analysis_view: [],
                    evaluate_view: [],
                    guest_view: [],
                    me_items: [{ img: './images/index/order.png', text: '订单' }, { img: './images/index/pjia.png', text: '评价' }, { img: './images/index/work.png', text: '作品' }, { img: './images/index/kaoqing.png', text: '考勤' }],
                    me_lines: [{ img: './images/index/pjia.png', text: '查询验证码', hash: "query_bind_code" }, { img: './images/index/ticket.png', text: '优惠券' }, { img: './images/index/organization.png', text: '组织' }, { img: './images/index/setting.png', text: '设置' }],
                    /*share_items:[
