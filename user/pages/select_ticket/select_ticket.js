class select_ticket extends Page {
    constructor(hash) {
        ...
        this.vue = new VueP({
            ...
            methods: {
                ...
                init() {
                    ...
                    Util.ajax(dataStr, `${db.data.api}getUserAvailableTicketList.php`, (data) => {
                        if (data.e !== 0) {
                        } else {
                            let i = 0;
                ...
                ticketChoose(tid) {
                    ...
                    Util.ajax(dataStr, `${db.data.api}setOrderTicket.php`, (data) => {
