...
var drain_guest_days = function (_Page) {
    _inherits(drain_guest_days, _Page);

    function drain_guest_days(hash) {
        _classCallCheck(this, drain_guest_days);
        ...
        return _possibleConstructorReturn(this, (drain_guest_days.__proto__ || Object.getPrototypeOf(drain_guest_days)).call(this, hash, html, css));
    }

    _createClass(drain_guest_days, [{
        key: 'vue_',
        value: function vue_() {
            this.vue = new VueP({
                el: this.hash + '_vue',
                ...
                compiled: function compiled() {
                    ...
                    obj.on('touchstart', function () {
                        if (obj[0].scrollHeight - obj.scrollTop() < 7 * $('body').height()) {
                            var dataStr = '{\n                            "start":' + _this2.start + ',\n                            "count":' + _this2.count + '\n                        }';
                            Util.ajax(dataStr, db.data.api + 'getDrainGuestDaysList.php', function (data) {
