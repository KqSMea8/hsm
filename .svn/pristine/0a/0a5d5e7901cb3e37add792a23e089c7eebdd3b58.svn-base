class MessageBarber{
    static alert(message){
        this.dialog('提示', message, '确定', '取消', function(){
    ...
    font-size: 4vw">${message}</td>
                     ...
                     <tr>
                      <td class="txtc" id="all_notice_button2" style="color:#666;font-size:4vw;border-top: solid 1px #ddd;padding: 4%;">${button2}</td>
                        <td class="txtc" id="all_notice_button1" style="background: red;color:#fff;font-size:4vw;padding: 4%;">${button1}</td>
                    </tr>
                </table>
            </div>
        </div>  
    ...
    font-size: 4vw">${message}</td>
                     ...
                     <tr>
                      <td class="txtc pos_r" id="all_notice_button1" style="color:#666;font-size:4vw;border-top: solid 1px #ddd;padding: 4%;">${button1}</td>
                        ...
                        <input style="position:absolute;width:100%;height:100%;opacity:0;left:0;top:0;" type="file" onchange="comment.vue.imgChange(this)" />
                        </td>
                    </tr>
                </table>
            </div>
...
`;
    ...
    static showTicket(title, ticketArr, button1, button2, func1, func2){
        let i,ticketsHtml='',ticket;
        let date1,date2,timeDiff,timeres;
